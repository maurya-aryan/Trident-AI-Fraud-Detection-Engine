...
export default function EndSection() {
  return (
    <section className="relative min-h-[60vh] w-full flex flex-col items-center justify-center px-6 py-20 bg-background z-10 border-t border-accent/10 overflow-hidden">
      ...
      <div className="z-20 text-center max-w-2xl relative">
